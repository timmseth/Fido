    ...
    <div class="col-xs-12">
        <div class="panel panel-primary animated bounce">
            ...
            <div class="panel-body" id="currentWorkspaceParent" name="currentWorkspaceParent">
                <!-- The Contents of this div will change often. -->
...
*/
  ...
  <p class="text-right">
  <a data-toggle="collapse" data-parent="#accordion" href="#strandInfo'.$row['panel_UID'].''.$rowx['number'].'" aria-expanded="true" aria-controls="collapseOne"><i class="fa text-danger text-right fa-fw fa-times"></i></a>
  </p>
...
?>
    ...
    <script type="text/javascript">
      ...
      htmltoInsert+='<input type="hidden" name="panel_a" id="panel_a" value="' + value_panelUID + '"> <input type="hidden" name="lastCabinet" id="lastCabinet" value="' + value_cabinetUID + '"> <input type="hidden" name="manageCabinetAction" id="manageCabinetAction" value="mapPanel">';
            ...
            //Mapping type:
            htmltoInsert+='<div class="form-group"> <div class="help-block"> <p>Select one of the following options first:</p> </div> <div class="radio"> <label> <input type="radio" name="mappingTypeOption" id="mappingTypeSixToSix" value="sixToSix" checked> Map a 6-port panel to another 6-port panel. </label> </div> <div class="radio"> <label> <input type="radio" name="mappingTypeOption" id="mappingTypeSixToTwelveLeft" value="sixToTwelveLeft"> Map a 6-port panel to the left-hand column of a 12-port panel (ports 1,3,5,7,9,11). </label> </div> <div class="radio"> <label> <input type="radio" name="mappingTypeOption" id="mappingTypeSixToTwelveRight" value="SixToTwelveRight"> Map a 6-port panel to the right-hand column of a 12-port panel (ports 2,4,6,8,10,12). </label> </div> <div class="radio"> <label> <input type="radio" name="mappingTypeOption" id="mappingTypeSixToTwelveTop" value="SixToTwelveTop"> Map a 6-port panel to the top half of a 12-port panel (ports 1-6). </label> </div> <div class="radio"> <label> <input type="radio" name="mappingTypeOption" id="mappingTypeSixToTwelveBottom" value="SixToTwelveBottom"> Map a 6-port panel to the bottom half of a 12-port panel (ports 7-12). </label> </div> <div class="radio"> <label> <input type="radio" name="mappingTypeOption" id="mappingTypeTwelveToTwelve" value="TwelveToTwelve"> Map a 12-port panel to another 12-port panel. </label> </div> </div>';
